...
class DarkDragonCore:
    ...
    [0] Exit
            """)
            choice = console.input(f"{C}Enter choice: {RESET}").strip()
            ...
            if choice == '1':
                ...
                console.print(f"{R}Exiting...{RESET}")
                self.running = False
            else:
                console.input(f"{R}Invalid choice. Press Enter...{RESET}")
